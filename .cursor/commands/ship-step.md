...
1. Read and follow [`.cursor/skills/step-ship/SKILL.md`](../skills/step-ship/SKILL.md) **Ship this step (combined)** in order.
...
4. Never force-push `main`; never skip `just verify` for non-RED work per `step-ship/SKILL.md`.
