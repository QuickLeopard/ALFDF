...
1. Read and follow [`.cursor/skills/step-ship.md`](../skills/step-ship.md): use **RED**, **GREEN / refactor**, or **Step review / docs** mode only. **Do not** push or open a PR unless the user asks separately.
...
4. Obey all **Stop conditions** in `step-ship.md` before any commit.
